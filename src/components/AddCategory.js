            ...
            <Modal
                ...
                onOk = { async () => {
                    await AddCategoryRef.current.validateFields().then(value => {
                        ...
                        axios.post('http://localhost:3001/category/add',{category:value}).then(result => {
                            props.closeForm();
                        ...
                        <Select
                            onChange={ async value => {
                                ...
                                if(value === 0) {
                                    ...
                                    await axios.get(`http://localhost:3001/category/pall/${value}`).then(result => {
                                     let arr=[];
                                     for(let a of result.data.data){
                                         let obj={
                                             cat_id:a.cat_id,
                                             cat_name:a.cat_name
                                         }
